...
final class Utils
{
    ...
    {
        \SimpleCalendar\plugin_deps\trigger_deprecation('guzzlehttp/guzzle', '7.1', '%s() is deprecated and will be removed in 8.0. This method is not needed in PHP 5.6+.', __METHOD__);
        static $cached = null;
        static $cafiles = [
...
EOT
    ...
    {
        \SimpleCalendar\plugin_deps\trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_decode() instead.', __METHOD__);
        if ($depth < 1) {
    ...
    {
        \SimpleCalendar\plugin_deps\trigger_deprecation('guzzlehttp/guzzle', '7.15', '%s() is deprecated and will be removed in 8.0. Use PHP\'s json_encode() instead.', __METHOD__);
